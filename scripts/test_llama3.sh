...
ACTOR_MODEL_NAME_OR_PATH="RLHFlow/LLaMA3-SFT"
ACTOR_REF_MODEL_NAME_OR_PATH="RLHFlow/LLaMA3-SFT"

OUTPUT_DIR="MCTS-DPO/outputs/checkpoints/llama3-sft-base"
unset HOSTFILE
ZERO_STAGE=3
OFFLOAD="optimizer"
...
deepspeed --include localhost:$gpu_vis --master_port $MASTER_PORT \
	...
	--train_datasets RLHFlow/iterative-prompt-v1-iter1-20K \
	--model_type llama3 \
	--choose_worst \
	--save_mcts_data \
	--filter \
